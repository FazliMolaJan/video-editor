...
public class Bitmap {
    ...
    public Bitmap(Context context, float leftX, float rightX, float topY, float bottomY,
                  float viewWidth, float viewHeight, android.graphics.Bitmap bitmap) {
    ...
    private void setupOpenGl() {
        ...
        int vertexShader = OpenGLUtil.createShader(GLES20.GL_VERTEX_SHADER, RiGraphicTools.vs_Image);
        if (vertexShader == 0) {
            return;
        }
...
//                RiGraphicTools.vs_Image);
        ...
        TextureRender.checkGlError("TextManager setupOpenGl");
    }
    ...
    private void setupImage() {
        ...
        TextureRender.checkGlError("TextManager setupImage");
    }
